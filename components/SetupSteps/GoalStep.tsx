...
export default function GoalStep({ value, onChange }: GoalStepProps) {
  ...
  const options = [
    { label: 'Lose Weight', val: 'lose', icon: 'trending-down-outline' as const, desc: 'Calculate a caloric deficit to slim down.' },
    { label: 'Maintain Weight', val: 'maintain', icon: 'swap-horizontal-outline' as const, desc: 'Keep your current physique steady.' },
    { label: 'Gain Muscle', val: 'gain', icon: 'trending-up-outline' as const, desc: 'Build mass and strength efficiently.' },
  ];

  return (
    <View style={styles.container}>
      <Text style={[styles.title, { color: themeColors.text }]}>What is your primary goal?</Text>
      <Text style={[styles.subtitle, { color: themeColors.textSecondary }]}>This directs our AI to calculate the perfect regime for your body.</Text>
